...
@section('container')
    ...
    <div class="table-responsive col-lg-6">
        <a href="/dashboard/categories/create" class="btn btn-primary mb-3"><i class="bi bi-clipboard-plus"></i> Category</a>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center">
                  <a href="/dashboard/categories/{{ $category->slug }}/edit" class="btn btn-sm btn-warning"><i class="bi bi-pencil-square"></i></span></a>
